...
func Display_lists_for_items_list(update *tgbotapi.Update) (tgbotapi.MessageConfig, error) {
	...
	err = session.Set_step(strconv.FormatInt(update.Message.Chat.ID, 10), session.SelectListForItemsDisplay)
